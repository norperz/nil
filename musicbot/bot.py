...
class MusicBot(discord.Client):
    ...
    async def update_now_playing(self, entry=None, is_paused=False):
        ...
        if self.user.bot:
            ...
            if activeplayers > 1:
                game = discord.Game(name="music on %s servers" % activeplayers, type=2)
                entry = None
        ...
        if entry:
            ...
            game = discord.Game(name=name, type=1, url="https://www.twitch.tv/norpdorp")
    ...
    async def cmd_setavatar(self, message, url=None):
        ...
        return Response(":regional_indicator_g: :regional_indicator_a: :regional_indicator_y: :ok-hand:", delete_after=20)


    async def cmd_disconnect(self, server):
        await self.disconnect_voice_client(server)
        return Response(":regional_indicator_g: :regional_indicator_a: :regional_indicator_y: ", delete_after=20)

    async def cmd_restart(self, channel):
        await self.safe_send_message(channel, ":regional_indicator_g: :regional_indicator_a: :regional_indicator_y: ")
        await self.disconnect_all_voice_clients()
